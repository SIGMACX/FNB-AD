...
class mlp(nn.Module):
    def __init__(self, in_chan, out_chan, drop_prob=0.0):
...
class FNB_UNet_MLP(nn.Module):
    """ Full assembly of the parts to form the complete network """
    def __init__(self, n_channels, n_classes, bilinear=True):
        super(FNB_UNet_MLP, self).__init__()
        ...
        self.up1 = SingUp(384, 128 // factor, bilinear)
        self.up2 = SingUp(128, 64 // factor, bilinear)
        self.up3 = SingUp(64, 32 // factor, bilinear)
        self.up4 = SingUp(32, 16, bilinear)
        self.outc = OutConv(16, n_classes)

        self.mlp_1 = mlp(in_chan=128, out_chan=256)
        self.mlp_2 = mlp(in_chan=256, out_chan=256)
