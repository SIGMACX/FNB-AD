# @Time: 2023/9/24 19:50
# @Author: ChenXi
# -*- coding: utf-8 -*-

# -------------------------------
# create FNB_UNet_SingConv_MLP
# -------------------------------
...
class FNB_UNet_SingConv_MLP(nn.Module):
    """ Full assembly of the parts to form the complete network """
    def __init__(self, n_channels, n_classes, bilinear=True):
        super(FNB_UNet_SingConv_MLP, self).__init__()
        ...
        self.down4 = SingDown(128, 256 // factor)
