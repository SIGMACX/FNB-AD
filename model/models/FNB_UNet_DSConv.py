# @Time: 2023/9/25 14:05
# @Author: ChenXi
# -*- coding: utf-8 -*-

# -------------------------------
# 前面使用双层卷积，后面使用单层卷积
# FNB_UNet_DouConv_SingConv
# -------------------------------
...
class FNB_UNet_DSConv(nn.Module):
    """ Full assembly of the parts to form the complete network """
    def __init__(self, n_channels, n_classes, bilinear=True):
        super(FNB_UNet_DSConv, self).__init__()
        ...
        self.sing_up1 = SingUp(256, 128 // factor, bilinear)
...
class FNB_UNet_DSConv_MLP(nn.Module):
    """ Full assembly of the parts to form the complete network """
    def __init__(self, n_channels, n_classes, bilinear=True):
        super(FNB_UNet_DSConv_MLP, self).__init__()
        self.n_channels = n_channels
        self.n_classes = n_classes
        self.bilinear = bilinear
